        ...
        <section className='w-full flex flex-col lg:flex-row justify-between items-center gap-10'>
            ...
            className='basis-2/3 w-full flex flex-col gap-9'>
                <div className='flex flex-col gap-4'>
                    <Motion.span   className='text-white font-jakarta flex items-center font-light text-2xl md:text-3xl'>Hi<img src={wavingIcon} alt="" className='w-7 md:w-9' />, {details.name} </Motion.span>
                    <div >
